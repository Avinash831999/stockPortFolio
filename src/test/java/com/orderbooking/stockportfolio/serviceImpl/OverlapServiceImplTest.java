...
class OverlapServiceImplTest {
    ...
    void calculateOverlapInfo_highRisk() {
        ...
        when(stockBasketRepository.findAll()).thenReturn(List.of(
                new StockBasketMap(1L, 1L, 10L, new Date(), new Date()),
                new StockBasketMap(2L, 1L, 11L, new Date(), new Date()),
                new StockBasketMap(3L, 2L, 20L, new Date(), new Date())
        ));
        when(holdingRepository.findByTraderId(1L)).thenReturn(List.of(
                new Holding(1L, 1L, 10L, 100L, 5, new Date()),
                new Holding(2L, 1L, 11L, 100L, 4, new Date())
        ));
    ...
    void calculateOverlapInfo_mediumRisk() {
        ...
        when(stockBasketRepository.findAll()).thenReturn(List.of(
                new StockBasketMap(1L, 1L, 10L, new Date(), new Date()),
                new StockBasketMap(2L, 1L, 11L, new Date(), new Date()),
                new StockBasketMap(3L, 1L, 12L, new Date(), new Date())
        ));
        when(holdingRepository.findByTraderId(1L)).thenReturn(List.of(
                new Holding(1L, 1L, 10L, 100L, 5, new Date()),
                new Holding(2L, 1L, 99L, 100L, 4, new Date())
        ));

        OverlapsInfo info = service.calculateOverlapInfo(1L);
//        assertEquals("MEDIUM", info.getRiskFlag());
    }
    ...
    void calculateOverlapInfo_lowRisk() {
        ...
        when(stockBasketRepository.findAll()).thenReturn(List.of(
                ...
                new StockBasketMap(2L, 1L, 11L, new Date(), new Date()),
                new StockBasketMap(3L, 1L, 12L, new Date(), new Date()),
                new StockBasketMap(4L, 1L, 13L, new Date(), new Date())
        ));
        when(holdingRepository.findByTraderId(1L)).thenReturn(List.of(
                new Holding(1L, 1L, 99L, 100L, 5, new Date()),
                new Holding(2L, 1L, 98L, 100L, 4, new Date())
        ));
